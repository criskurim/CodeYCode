...
def func_principal():
    ...
    ui.label.setText("Olá, eu sou Bet, sua assistente virtual!")
    print(bet_inicio)
    sintese_voz(bet_inicio)
    conteudo = agenda_c_bd.lembrete_jogo()
    print(conteudo)
    ui.listWidget.addItem(conteudo)
    
    #loop para ouvir continuamente
    ouvindo = True
    while ouvindo:
        bet_diz = 'Dê um comando!'
        ui.label.setText("Dê um comando!")
...
ui = uic.loadUi("testeTela.ui")
ui.pushButton.clicked.connect(func_principal)
